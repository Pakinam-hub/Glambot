...
const chatbotDataset = [
  ...
  {
    question: ["what's your name?", "who are you?", "what do you do?","introduce yourself"],
  ...
  {    question: ["What is the best way to take care of my skin?", "How can I get better skin?"],
  ...
  {
    question: ["What makeup products should I use for a natural look?"],
  ...
  {
    question: ["What are some tips for preventing breakouts?"],
  ...
  {
    question: ["What is the best way to apply foundation?"],
  ...
  {
    question: ["What's the best way to apply foundation?"],
    answer: "The best way to apply foundation is to start with a clean, moisturized face and use a makeup brush, sponge, or your fingers to apply it in a thin layer, blending it well into your skin.",
  },
  {
  ...
  {
    question: ["How can I make my hair shinier?"],
  ...
  {
    question: ["how do i know my lipstick shade"],
  ...
  {
    question: ["bye","goodbye","see you soon","good night"],
    answer: "Good bye!."
  }
];
